...
project = 'Дигитални свет за 3. разред'
#pylint: disable=redefined-builtin
copyright = '2022 Petlja'
...
html_context = {'course_id': 'DigitalniSvet',
...
html_theme_options = {
    ...
    'navbar_title': "Дигитални свет за 3. разред",
...
html_title = 'Дигитални свет за 3. разред'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Дигитални свет за 3. разред'
...
htmlhelp_basename = 'DigitalniSvet-doc'
